...
> Auto-updated every hour | Last sync: 2026-04-02 04:50 UTC
...
| **v2.0.71** | 2025-12-16 | `/config`, `/settings`, `--dangerously-skip-permissions` | Added /config toggle to enable/disable prompt suggestions / Added /settings as an alias for the /config command / Bedrock: Environment variable ANTHROPIC_BEDROCK_BASE_URL is now respected for token... |
