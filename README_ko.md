...
[![Auto Sync](https://img.shields.io/badge/sync-매일-blue)](https://github.com/tryumanshow/claude-code-changelog/actions)
...
**매일 오전 6시(KST)** 공식 CHANGELOG.md를 파싱하여 버전별 새 커맨드, CLI 플래그, 주요 기능을 정리합니다.
...
```
GitHub Actions (매일 06:00 KST cron)
  |
  v
...
| Source | 용도 | 비고 |
|--------|------|------|
| [CHANGELOG.md](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) | 버전, 커맨드, 기능 텍스트 | 매일 fetch |
...
├── .github/workflows/
│   └── track-releases.yml       # GitHub Actions (매일 06:00 KST cron)
├── scripts/
